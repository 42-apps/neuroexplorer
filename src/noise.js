/* 3D Simplex noise — adapted from Stefan Gustavson's public-domain reference,
   with a seedable permutation table (mulberry32). Used to sculpt cortical gyri. */
...
export class SimplexNoise {
  ...
  /* Fractal Brownian motion — layered octaves for natural-looking folds. */
